...
class DocumentIngestor:
    ...
    def __init__(self, temp_dir:str = "data/multi_document_chat", faiss_dir:str = "faiss_index", session_id: str | None = None):
        try:
            ...
            raise EnterpriseDocumentChatException("Initialization error in DocumentIngestor", sys)
        ...
        try:
            ...
            for uploaded_file in uploaded_files:
                ...
                if ext not in self.SUPPORTED_EXTENSIONS:
                    self.log.warning(f"Unsupported file type skipped", file_name=uploaded_file.name)
                    continue
            ...
            if not documents:
                raise EnterpriseDocumentChatException("No valid documents were ingested", sys)
